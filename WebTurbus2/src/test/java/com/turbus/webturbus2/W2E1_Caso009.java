...
public class W2E1_Caso009 {
    ...
    public void testPrueba() throws Exception {
        ...
        getFoto(driver);
        Thread.sleep(8000);
        driver.findElement(By.xpath("//div[5]/div/div")).click();//Selección asiento ida pasajero 1
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li/button")).click();
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//div[2]/div/div[2]/div/div")).click();//Selección asiento ida pasajero 2
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li/button")).click();
        getFoto(driver);
        ...
        getFoto(driver);
        Thread.sleep(10000);
        driver.findElement(By.xpath("//div[2]/div/div/div/div[2]/div/div/div/div")).click();//Selección asiento vuelta pasajero 1
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li/button")).click();
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//div[2]/div/div[2]/div/div")).click();//Selección asiento vuelta pasajero 2
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li/button")).click();
        getFoto(driver);
