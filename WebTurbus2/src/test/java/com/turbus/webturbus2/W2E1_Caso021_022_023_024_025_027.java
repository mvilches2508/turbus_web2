...
public class W2E1_Caso021_022_023_024_025_027 {
    ...
    @Test
    public void testW2E1_Caso021_022_023_024_025_027() throws Exception {//Validación correspondiente a datos de pasajeron (no pueden quedar en blanco) selección de asientos
        driver.get(baseUrl);
        Thread.sleep(3000);
        getFoto(driver);
