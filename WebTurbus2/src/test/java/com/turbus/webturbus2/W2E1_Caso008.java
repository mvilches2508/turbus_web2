...
public class W2E1_Caso008 {
    ...
    @Test
    public void testW2E1_Caso008() throws Exception {//Script de prueba
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//div/div/div/label/input")).clear();
        driver.findElement(By.xpath("//div/div/div/label/input")).sendKeys("Copiapo");
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//div[2]/div[2]/ul/li")).click();
        getFoto(driver);
        ...
        driver.findElement(By.id("idPersona")).sendKeys("241284506");
        getFoto(driver);
        Thread.sleep(1000);
        ...
        Thread.sleep(20000);
        int asientoVuelta = 2;
        WebElement asientosVuelta = driver.findElement(By.className("bus_seat"));//Selección de asientos vuelta
    ...
    private void getFoto(WebDriver webDriver) {
        try {
            File path = new File("src/test/java/evidencia/W2E1_Caso008");
            path.mkdir();
            Date d = new Date();
