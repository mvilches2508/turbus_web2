...
public class W2E1_Caso012 {
    ...
    @Test
    public void testW2E1_Caso012() throws Exception {//Scrip de prueba
        ...
        getFoto(driver);
        driver.findElement(By.xpath("//app-itinerario/div/div/div[2]/div/div/div[2]")).click();//Selección de itinerario
        getFoto(driver);
        Thread.sleep(3000);
